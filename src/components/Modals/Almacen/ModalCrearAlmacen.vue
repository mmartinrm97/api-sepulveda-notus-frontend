          ...
          <TransitionChild as="template" enter="ease-out duration-300"
            ...
            <DialogPanel
              ...
              <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  ...
                  <div class="mx-auto align-middle text-center sm:mt-0 sm:ml-6 sm:text-left">
                    <DialogTitle as="h3" class="text-2xl font-medium text-gray-900"> Añadir nuevo almacen
                    </DialogTitle>
                    <!-- <div class="mt-2">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                      <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                          ...
                          <div class="col-span-6 sm:col-span-6">
                            <label for="country" class="block text-sm font-medium text-gray-700">Usuario Encargado</label>
                            <select id="user" name="user" autocomplete="country-name"
                              ...
                              <option v-if="userStore.allUsers"
                                v-for="user in userStore.allUsers.data" :value="user.id">
                                {{user.last_name }} {{ user.first_name }}</option>
                            </select>
                            <span v-if="erroresPost.user_id" class="text-red-700">{{ erroresPost.user_id
                            }}</span>
                          </div>
              ...
              <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="button" name="anadirAlmacen"
                  ...
                  @click="anadirAlmacen" :disabled="btnBloqueado" :class="btnBloqueado ? 'cursor-not-allowed' : ''">Añadir
                </button>
...
const open = inject('showModalCrearAlmacen');
...
const anadirAlmacen = (async () => {
  try {
    erroresPost.value = {}
    btnBloqueado.value = true
    await almacenStore.postAlmacen(state.almacen)
    ...
    Swal.fire({
      title: 'Éxito',
      text: 'Almacen añadido satisfactoriamente',
      icon: 'success',
      confirmButtonText: 'Cerrar'
    })
