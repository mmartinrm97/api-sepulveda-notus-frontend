<template>
    <TransitionRoot as="template" :show="open">
        <Dialog as="div" class="relative z-10" @close="open = false" className="pointer-events-none">
                            ...
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    ...
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div class="mt-2">
                                            <!-- <p class="text-sm text-gray-500">Espere  </p> -->
                                            <p class="text-sm text-gray-500"> Esta ventana se cerrará automáticamente
                                                cuando termine el proceso</p>
...
const open = inject('showModalReporte');
