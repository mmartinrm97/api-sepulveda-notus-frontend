              ...
              <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  ...
                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <DialogTitle as="h3" class="text-lg leading-6 font-medium text-gray-900"> Eliminar usuario:
                      {{ userAEliminar.first_name}} {{userAEliminar.last_name}}</DialogTitle>
                    <div class="mt-2">
                      <p class="text-sm text-gray-500">¿Estás seguro de eliminar este usuario? </p>
...
const open = inject('showModalEliminarUser');
const userAEliminar = inject('userAEliminar')
const emit = defineEmits(['refrescarUsers']);

const erroresDelete = ref(userStore.errores)
...
const eliminarUser = (async () => {
  try {
    ...
    // console.log('despues del delete', userStore.errores);
    ...
    if (Object.keys(userStore.errores).length !== 0) {
      ...
      erroresDelete.value = userStore.errores
      return;
    }
