          ...
          <TransitionChild as="template" enter="ease-out duration-300"
            ...
            <DialogPanel
              ...
              <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  ...
                  <div class="mx-auto align-middle text-center sm:mt-0 sm:ml-6 sm:text-left">
                    <DialogTitle as="h3" class="text-2xl font-medium text-gray-900"> Editar usuario
                    </DialogTitle>
                    <!-- <div class="mt-2">
              ...
              <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="button" name="actualizarUser"
                  ...
                  @click="actualizarUser" :disabled="btnBloqueado"
                  :class="btnBloqueado ? 'cursor-not-allowed' : ''">Añadir
                </button>
...
const open = inject('showModalEditarUser');
const userAEditar = inject('userAEditar')
...
const state = reactive({
  user: {
    id: userAEditar.value.id,
    rolID: userAEditar.value.role_id,
    nombres: userAEditar.value.first_name,
    apellidos: userAEditar.value.last_name,
    dni: userAEditar.value.dni,
    email: userAEditar.value.email,
    password: userAEditar.value.password,
    passwordConfirmado: userAEditar.value.password,
    activo: userAEditar.value.is_active,
  }
})
...
const actualizarUser = (async () => {
  try {
    ...
    await userStore.patchUser(state.user)
